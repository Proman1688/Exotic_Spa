  ...
  return (
    <div className="relative flex items-center justify-center w-180 h-135 border-2 rounded-4xl mx-5">
      ...
      <div className="relative flex w-full p-4">
        <img src="/buso.png" alt="Logo" className="flex w-1/2 hidden  md:block " />
        {/* Sección de formulario */}
        <div className="w-full md:w-1/2 p-6 text-white items-center justify-center">
          <h2 className=" text-3xl font-bold text-center">Create an account</h2>
          <p className="text-sm mt-1 text-center">Already have an account? <a href="/login" className="text-blue-400">Log in</a></p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="terms" className="text-xs">I agree to the <a href="#" className="text-blue-400">Terms & Conditions</a></label>
            </div>
          ...
          <div className="flex gap-4">
            <button className="flex items-center gap-2 w-1/2 p-2 border rounded-md hover:bg-gray-700 transition">
              <img src="/logo_google.png" alt="Google" className="w-8"/>
              Google
            </button>
            <button className="flex items-center gap-2 w-1/2 p-2 border rounded-md hover:bg-gray-700 transition">
              <img src="/logo_apple.png" alt="Apple" className="w-8"/>
              Apple
            </button>
          </div>
        </div>
