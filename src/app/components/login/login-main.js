        ...
        <div className="relative flex w-full md:p-4 p-2">
          ...
          <div className="w-full md:w-1/2 p-6 text-white items-center justify-center">
            ...
            <div className="mt-8 space-y-3">
              ...
              <a href="/sign-up" className="text-gray-700 text-[12px]">Forgot password?</a>
            ...
            <p className="text-sm mt-5 text-center">Don't have an account? <a href="/sign-up" className="text-blue-400">Login</a></p>
          </div>
          <img src="/buso-2.png" alt="Logo" className="hidden md:block w-1/2 " />
        </div>
      </div>
    );
  }
