export default function Dashboard(){
    return (
        <section className="relative flex flex-col items-center justify-center text-white p-10 rounded-2xl mb-10 max-[375px]:p-0">
            <h1 className="text-5xl font-bold flex items-center mb-3 text-center max-sm:text-3xl max-sm:flex-col">Dashboard</h1>
            <p className="text-base mb-10 max-sm:text-xs text-center">Aquí puedes gestionar el sistema.</p>
